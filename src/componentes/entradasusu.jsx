...
function EntradasUsu() {
  const [canjeos, setCanjeos] = useState(JSON.parse(localStorage.getItem("canjeos")) || []);
  const [busqueda, setBusqueda] = useState("");

  useEffect(() => {
    if (busqueda.trim() === "") {
      setCanjeos(JSON.parse(localStorage.getItem("canjeos")) || []);
      return;
    }
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Lista de Canjeos</h1>
      <input
        type="text"
